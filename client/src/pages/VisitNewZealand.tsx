...
const VisitNewZealand = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const subject = 'Visit New Zealand Visa Inquiry';
  ...
  const visaTypes = [
    { name: "Visitor Visa", features: ["Tourism", "Family visits", "Business trips", "Short stays"], gradient: "from-slate-600 to-blue-900" },
    { name: "Business Visitor Visa", features: ["Meetings", "Conferences", "Trade shows", "Business activities"], gradient: "from-blue-600 to-cyan-600" },
    { name: "Transit Visa", features: ["Airport transit", "Short layovers", "Connecting flights", "48-hour transit"], gradient: "from-green-600 to-emerald-600" },
    { name: "Family Visitor Visa", features: ["Visiting family", "Extended stays", "Multiple entries", "Long-term visits"], gradient: "from-purple-600 to-indigo-600" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <section className="relative h-[520px] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-slate-900/90 via-blue-900/80 to-indigo-900/80"></div>
        ...
        <div className="relative z-10 container mx-auto px-4 w-full">
          <div className="max-w-6xl mx-auto">
            <nav className="text-sm text-white/80 mb-6">
              ...
              <span className="text-white">Visit New Zealand</span>
            </nav>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center text-white">
              <div>
                ...
                >
                  Experience New Zealand's breathtaking landscapes, adventure sports, and unique culture. Get expert visa assistance for your Kiwi adventure.
                </motion.p>
              ...
              <div className="hidden md:block">
                <div className="glass-effect rounded-2xl p-6 shadow-neon-lg">
                  <div className="grid grid-cols-2 gap-4">
                    {[{label: 'Visa Types', value: '4+'}, {label: 'Processing', value: '15-20 Days'}, {label: 'Success Rate', value: '98%'}, {label: 'Validity', value: '9 Months'}].map((s, idx) => (
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              >
                ...
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  New Zealand offers stunning natural beauty from fjords and glaciers to pristine beaches and geothermal wonders. Known for adventure sports, friendly locals, and world-class wineries, New Zealand is a dream destination for travelers seeking unique experiences.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  New Zealand visitor visas allow you to explore this beautiful country for tourism, business, or visiting family and friends. With proper documentation and expert guidance, you can obtain a visa that enables memorable experiences across both islands.
                </p>
              </motion.div>

              <div className="grid md:grid-cols-2 gap-6">
                {[
                  { icon: Plane, title: "Visitor Visa", desc: "Perfect for tourism, family visits, and short stays" },
                  { icon: MapPin, title: "Business Visitor Visa", desc: "For business meetings, conferences, and training" },
                  { icon: Calendar, title: "Quick Processing", desc: "15-20 days processing with expert assistance" },
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-4">New Zealand Visa Types</h2>
              <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold mb-8">Our New Zealand Visit Visa Services</h2>
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-xl font-semibold mb-4 flex items-center"><FileText className="mr-2 text-slate-600" size={24} />Required Documents</h3>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start"><CheckCircle className="text-slate-600 mr-2 mt-1" size={18} /><span>Valid passport (6+ months validity)</span></li>
                      <li className="flex items-start"><CheckCircle className="text-slate-600 mr-2 mt-1" size={18} /><span>Completed visa application form</span></li>
                      <li className="flex items-start"><CheckCircle className="text-slate-600 mr-2 mt-1" size={18} /><span>Recent photographs</span></li>
                      <li className="flex items-start"><CheckCircle className="text-slate-600 mr-2 mt-1" size={18} /><span>Financial documents (bank statements)</span></li>
                      <li className="flex items-start"><CheckCircle className="text-slate-600 mr-2 mt-1" size={18} /><span>Travel itinerary and accommodation</span></li>
                      <li className="flex items-start"><CheckCircle className="text-slate-600 mr-2 mt-1" size={18} /><span>Return flight booking</span></li>
                    </ul>
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold mb-4 flex items-center"><DollarSign className="mr-2 text-slate-600" size={24} />Processing Details</h3>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start"><CheckCircle className="text-slate-600 mr-2 mt-1" size={18} /><span>Processing Time: 15-20 days</span></li>
                      <li className="flex items-start"><CheckCircle className="text-slate-600 mr-2 mt-1" size={18} /><span>Visa Fee: NZD $211 (approx. ₹11,000)</span></li>
                      <li className="flex items-start"><CheckCircle className="text-slate-600 mr-2 mt-1" size={18} /><span>Validity: Up to 9 months</span></li>
                      <li className="flex items-start"><CheckCircle className="text-slate-600 mr-2 mt-1" size={18} /><span>Stay Duration: Up to 9 months</span></li>
                      <li className="flex items-start"><CheckCircle className="text-slate-600 mr-2 mt-1" size={18} /><span>Multiple entries allowed</span></li>
                    </ul>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="divide-y divide-gray-200">
                  {[
                    { q: 'How long can I stay in New Zealand on a visitor visa?', a: 'Visitor visas typically allow stays of up to 9 months, depending on your individual circumstances and the purpose of your visit.' },
                    { q: 'Do I need to provide biometrics for New Zealand visa?', a: 'Yes, most applicants need to provide biometrics (fingerprints and photo) at a Visa Application Centre. This is usually done during the application process.' },
                    { q: 'Can I work in New Zealand on a visitor visa?', a: 'No, visitor visas do not permit work. However, you can attend business meetings, conferences, and training sessions. Any paid work requires a different visa category.' },
                    { q: 'Can I extend my stay in New Zealand?', a: 'You can apply to extend your visitor visa before your authorized stay expires, but approval depends on your circumstances. It\'s best to plan your travel within the initial visa validity.' }
                  ].map((item, idx) => (
            ...
            <aside className="lg:col-span-1">
              <div className="lg:sticky lg:top-24 space-y-6">
                <div className="bg-white rounded-2xl shadow-xl p-6">
                  ...
                  <h3 className="text-xl font-bold mb-2">Talk to a New Zealand Visa Expert</h3>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-stretch">
              ...
              >
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
                  Start Your New Zealand Visit Journey
                </h2>
