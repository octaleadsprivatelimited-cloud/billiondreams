...
const VisitSingapore = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const subject = 'Visit Singapore Visa Inquiry';
  ...
  const visaTypes = [
    { name: "Tourist Visa", features: ["Leisure travel", "Sightseeing", "Shopping", "Short stays"], gradient: "from-red-600 to-pink-600" },
    { name: "Business Visa", features: ["Business meetings", "Conferences", "Trade shows", "Commercial activities"], gradient: "from-blue-600 to-indigo-600" },
    ...
    { name: "Social Visit Visa", features: ["Family visits", "Extended stays", "Multiple entries", "Long-term visits"], gradient: "from-purple-600 to-violet-600" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <section className="relative h-[520px] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-red-900/90 via-pink-900/80 to-blue-900/80"></div>
        ...
        <div className="relative z-10 container mx-auto px-4 w-full">
          <div className="max-w-6xl mx-auto">
            <nav className="text-sm text-white/80 mb-6">
              ...
              <span className="text-white">Visit Singapore</span>
            </nav>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center text-white">
              <div>
                ...
                >
                  Discover Singapore's modern cityscape, diverse culture, and world-class attractions. Get expert visa assistance for your Singapore adventure.
                </motion.p>
              ...
              <div className="hidden md:block">
                <div className="glass-effect rounded-2xl p-6 shadow-neon-lg">
                  <div className="grid grid-cols-2 gap-4">
                    {[{label: 'Visa Types', value: '4+'}, {label: 'Processing', value: '3-7 Days'}, {label: 'Success Rate', value: '98%'}, {label: 'Validity', value: '30-90 Days'}].map((s, idx) => (
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              >
                ...
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Singapore offers a perfect blend of modern architecture, rich culture, and world-class attractions. From Marina Bay Sands and Sentosa Island to vibrant neighborhoods and diverse cuisine, Singapore promises unforgettable experiences.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Singapore visitor visas are efficient to obtain with quick processing times. Many nationalities enjoy visa-free entry or can easily obtain tourist or business visas for short or extended stays in this cosmopolitan destination.
                </p>
              </motion.div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  { icon: Calendar, title: "Fast Processing", desc: "3-7 days processing with expert support" },
                  { icon: ShieldCheck, title: "Visa-Free Entry", desc: "Available for eligible passport holders" }
                ].map((benefit, index) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0, y: 30 }}
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-4">Singapore Visa Types</h2>
              <div className="grid md:grid-cols-2 gap-6">
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="bg-gradient-to-br from-red-600 to-pink-600 rounded-2xl shadow-xl p-8 md:p-12 text-white"
              >
                <h2 className="text-3xl md:text-4xl font-bold mb-8">Our Singapore Visit Visa Services</h2>
              ...
              >
                ...
                <div className="relative border-l-2 border-red-100 pl-6">
                  {[
                    ...
                    { icon: Plane, title: 'Travel', desc: 'Travel to Singapore with approved visa' }
                  ].map((step, idx) => (
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li className="flex items-start"><CheckCircle className="text-red-600 mr-2 mt-1" size={18} /><span>Return flight booking</span></li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start"><CheckCircle className="text-red-600 mr-2 mt-1" size={18} /><span>Processing Time: 3-7 days</span></li>
                      <li className="flex items-start"><CheckCircle className="text-red-600 mr-2 mt-1" size={18} /><span>Visa Fee: $30-100 (approx. ₹2,500-₹8,500)</span></li>
                      <li className="flex items-start"><CheckCircle className="text-red-600 mr-2 mt-1" size={18} /><span>Validity: 30-90 days</span></li>
                      <li className="flex items-start"><CheckCircle className="text-red-600 mr-2 mt-1" size={18} /><span>Stay Duration: Up to 30-90 days</span></li>
                      <li className="flex items-start"><CheckCircle className="text-red-600 mr-2 mt-1" size={18} /><span>Single/Multiple entries</span></li>
                    </ul>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="divide-y divide-gray-200">
                  {[
                    { q: 'Do I need a visa to visit Singapore?', a: 'Visa requirements depend on your nationality. Many countries enjoy visa-free entry for stays up to 30-90 days, while others need to apply for a visa in advance or obtain eVISA.' },
                    { q: 'How long does Singapore visa processing take?', a: 'Standard processing typically takes 3-7 working days. Express services can process visas faster for urgent travel needs.' },
                    { q: 'What is Singapore eVISA?', a: 'eVISA is an electronic visa system that allows eligible applicants to apply online without visiting an embassy. It\'s quick, convenient, and ideal for tourist visits.' },
                    { q: 'Can I extend my stay in Singapore?', a: 'You can apply to extend your visitor visa at immigration offices in Singapore before your authorized stay expires. Extensions are granted based on circumstances and justification.' }
                  ].map((item, idx) => (
                ...
                <div className="bg-white rounded-2xl shadow-xl p-6">
                  <div className="relative mb-4">
                    <img
                      ...
                      alt="Singapore Visit Visa Expert"
                      className="w-full h-40 rounded-xl object-cover ring-4 ring-red-50"
                    />
                  </div>
                  <h3 className="text-xl font-bold mb-2">Talk to a Singapore Visa Expert</h3>
      ...
      <section id="assessment" className="py-16 md:py-24 bg-gradient-to-br from-slate-900 via-red-900 to-pink-900">
        <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-stretch">
              ...
              >
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
                  Start Your Singapore Visit Journey
                </h2>
              ...
              <div className="order-1 md:order-2">
                <img
                  src="/services/study_visa.jpg"
                  alt="Visit Singapore visa consultation"
