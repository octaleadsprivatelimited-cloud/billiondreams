...
const VisitMalaysia = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const subject = 'Visit Malaysia Visa Inquiry';
  ...
  const visaTypes = [
    { name: "Tourist Visa", features: ["Leisure travel", "Sightseeing", "Family visits", "Short stays"], gradient: "from-blue-600 to-yellow-600" },
    { name: "Business Visa", features: ["Business meetings", "Conferences", "Trade shows", "Commercial activities"], gradient: "from-red-600 to-blue-600" },
    { name: "Transit Visa", features: ["Airport transit", "Short layovers", "Connecting flights", "120-hour transit"], gradient: "from-blue-600 to-cyan-600" },
    { name: "Social Visit Visa", features: ["Family visits", "Extended stays", "Multiple entries", "Long-term visits"], gradient: "from-green-600 to-emerald-600" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <section className="relative h-[520px] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-blue-900/90 via-red-900/80 to-yellow-900/80"></div>
        ...
        <div className="relative z-10 container mx-auto px-4 w-full">
          <div className="max-w-6xl mx-auto">
            <nav className="text-sm text-white/80 mb-6">
              ...
              <span className="text-white">Visit Malaysia</span>
            </nav>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center text-white">
              <div>
                ...
                >
                  Discover Malaysia's stunning beaches, vibrant culture, and modern cities. Get expert visa assistance for your Malaysian adventure.
                </motion.p>
              ...
              <div className="hidden md:block">
                <div className="glass-effect rounded-2xl p-6 shadow-neon-lg">
                  <div className="grid grid-cols-2 gap-4">
                    {[{label: 'Visa Types', value: '4+'}, {label: 'Processing', value: '5-7 Days'}, {label: 'Success Rate', value: '98%'}, {label: 'Validity', value: '3 Months'}].map((s, idx) => (
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              >
                ...
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Malaysia offers a perfect blend of tropical paradise, modern architecture, and rich cultural heritage. From the iconic Petronas Twin Towers in Kuala Lumpur to pristine beaches of Langkawi and Borneo's wildlife, Malaysia promises unforgettable experiences.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Malaysian visitor visas are straightforward to obtain with quick processing times. Many nationalities enjoy visa-free entry or visa-on-arrival, while others can easily obtain tourist or business visas for short or extended stays.
                </p>
              </motion.div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  { icon: Calendar, title: "Quick Processing", desc: "5-7 days processing with expert support" },
                  { icon: ShieldCheck, title: "Affordable Fees", desc: "Budget-friendly visa options available" }
                ].map((benefit, index) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0, y: 30 }}
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-4">Malaysia Visa Types</h2>
              <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold mb-8">Our Malaysia Visit Visa Services</h2>
                <ul className="grid md:grid-cols-2 gap-4">
                  {[
                    ...
                    "Visa approval letter (VAL) guidance",
              ...
              >
                ...
                <div className="relative border-l-2 border-blue-100 pl-6">
                  {[
                    ...
                    { icon: Plane, title: 'Travel', desc: 'Travel to Malaysia with approved visa' }
                  ].map((step, idx) => (
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li className="flex items-start"><CheckCircle className="text-blue-600 mr-2 mt-1" size={18} /><span>Return flight booking</span></li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start"><CheckCircle className="text-blue-600 mr-2 mt-1" size={18} /><span>Processing Time: 5-7 days</span></li>
                      <li className="flex items-start"><CheckCircle className="text-blue-600 mr-2 mt-1" size={18} /><span>Visa Fee: $30-100 (approx. ₹2,500-₹8,500)</span></li>
                      <li className="flex items-start"><CheckCircle className="text-blue-600 mr-2 mt-1" size={18} /><span>Validity: 1-3 months</span></li>
                      <li className="flex items-start"><CheckCircle className="text-blue-600 mr-2 mt-1" size={18} /><span>Stay Duration: Up to 30 days</span></li>
                      <li className="flex items-start"><CheckCircle className="text-blue-600 mr-2 mt-1" size={18} /><span>Single/Multiple entries</span></li>
                    </ul>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="divide-y divide-gray-200">
                  {[
                    { q: 'Do I need a visa to visit Malaysia?', a: 'Visa requirements depend on your nationality. Many countries enjoy visa-free entry for stays up to 30-90 days, while others need to apply for a visa in advance or obtain eVISA.' },
                    { q: 'How long does Malaysia visa processing take?', a: 'Standard processing typically takes 5-7 working days. eVISA applications can be processed faster, often within 24-48 hours for eligible applicants.' },
                    { q: 'What is Malaysia eVISA?', a: 'eVISA is an electronic visa system that allows eligible applicants to apply online without visiting an embassy. It\'s quick, convenient, and ideal for short tourist visits.' },
                    { q: 'Can I extend my stay in Malaysia?', a: 'You can apply to extend your visitor visa at immigration offices in Malaysia before your authorized stay expires. Extensions are granted based on circumstances and justification.' }
                  ].map((item, idx) => (
                ...
                <div className="bg-white rounded-2xl shadow-xl p-6">
                  <div className="relative mb-4">
                    <img
                      ...
                      alt="Malaysia Visit Visa Expert"
                      className="w-full h-40 rounded-xl object-cover ring-4 ring-blue-50"
                    />
                  </div>
                  <h3 className="text-xl font-bold mb-2">Talk to a Malaysia Visa Expert</h3>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-stretch">
              ...
              >
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
                  Start Your Malaysia Visit Journey
                </h2>
              ...
              <div className="order-1 md:order-2">
                <img
                  src="/services/study_visa.jpg"
                  alt="Visit Malaysia visa consultation"
