...
import { CheckCircle, Mail, ClipboardCheck, Languages, Users, Plane, ShieldCheck, FileText, Globe } from 'lucide-react';
...
const WorkPermitAdditional = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const subject = 'Work Permit Additional Services Inquiry';
