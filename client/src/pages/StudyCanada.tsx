...
const StudyCanada = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const subject = 'Study in Canada Inquiry';
  ...
  const universities = [
    { name: "Top Research Universities", programs: ["University of Toronto", "McGill University", "University of British Columbia", "University of Alberta"], gradient: "from-red-600 to-red-800" },
    { name: "Engineering Leaders", programs: ["University of Waterloo", "University of Toronto", "UBC", "University of Alberta"], gradient: "from-blue-600 to-cyan-600" },
    { name: "Business Schools", programs: ["Rotman (UofT)", "Ivey (Western)", "Sauder (UBC)", "Desautels (McGill)"], gradient: "from-green-600 to-emerald-600" },
    { name: "Comprehensive Universities", programs: ["University of Montreal", "York University", "Simon Fraser University", "Carleton University"], gradient: "from-orange-600 to-amber-600" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <section className="relative h-[520px] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-red-900/90 via-red-800/80 to-red-700/80"></div>
        ...
        <div className="relative z-10 container mx-auto px-4 w-full">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center text-white">
              <div>
                ...
                >
                  Experience high-quality education in one of the world's safest and most welcoming countries with excellent post-graduation opportunities.
                </motion.p>
              ...
              <div className="hidden md:block">
                <div className="glass-effect rounded-2xl p-6 shadow-neon-lg">
                  <div className="grid grid-cols-2 gap-4">
                    {[{label: 'Top Universities', value: '200+'}, {label: 'International Students', value: '600K+'}, {label: 'Post-Grad Work', value: '3 Years'}, {label: 'Success Rate', value: '98%'}].map((s, idx) => (
          ...
          <div className="mt-8">
            <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
              {[{icon: GraduationCap, label: 'Quality Education'}, {icon: Award, label: 'Affordable Costs'}, {icon: TrendingUp, label: 'PR Pathway'}, {icon: Plane, label: 'Visa Support'}].map((it, idx) => (
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              >
                ...
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Canada is consistently ranked among the top countries for quality of life, safety, and education. Canadian degrees are globally recognized and highly valued. The country offers affordable tuition fees compared to other popular destinations and provides excellent opportunities for permanent residency after graduation.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  With over 200 universities and colleges, Canada offers diverse programs and research opportunities. The Post-Graduation Work Permit (PGWP) allows graduates to work for up to 3 years, making it easier to gain Canadian work experience and qualify for permanent residency.
                </p>
              </motion.div>

              <div className="grid md:grid-cols-2 gap-6">
                {[
                  { icon: GraduationCap, title: "Affordable Education", desc: "Lower tuition fees than US/UK with high quality" },
                  { icon: Award, title: "Work Opportunities", desc: "PGWP allows 3 years of post-study work" },
                  { icon: TrendingUp, title: "PR Pathway", desc: "Express Entry and Provincial Nominee Programs" },
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold mb-8">Our Canada Study Services</h2>
                <ul className="grid md:grid-cols-2 gap-4">
                  {[
                    "University selection and application support",
                    "IELTS/TOEFL preparation and registration",
                    "SOP and essay writing assistance",
                    "Letters of recommendation guidance",
                    "Scholarship and funding opportunities",
                    "Study permit application support",
                    "GIC (Guaranteed Investment Certificate) guidance",
                    ...
                    "Permanent residency pathway guidance"
                  ].map((service, index) => (
              ...
              >
                ...
                <div className="relative border-l-2 border-red-100 pl-6">
                  {[
                    ...
                    { icon: FileText, title: 'Language Test', desc: 'IELTS 6.0+ or TOEFL iBT 80+ preparation' },
                    { icon: Target, title: 'Documentation', desc: 'SOP, transcripts, and references preparation' },
                    { icon: ShieldCheck, title: 'Study Permit', desc: 'Visa application and biometrics' },
                    { icon: Plane, title: 'Pre-Departure', desc: 'GIC, medical, and travel arrangements' }
                  ].map((step, idx) => (
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li className="flex items-start"><CheckCircle className="text-red-600 mr-2 mt-1" size={18} /><span>Letters of Recommendation (2-3)</span></li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start"><CheckCircle className="text-red-600 mr-2 mt-1" size={18} /><span>Tuition: CAD $15,000 - $35,000</span></li>
                      <li className="flex items-start"><CheckCircle className="text-red-600 mr-2 mt-1" size={18} /><span>Living: CAD $12,000 - $15,000</span></li>
                      <li className="flex items-start"><CheckCircle className="text-red-600 mr-2 mt-1" size={18} /><span>GIC: CAD $10,000 (refundable)</span></li>
                      <li className="flex items-start"><CheckCircle className="text-red-600 mr-2 mt-1" size={18} /><span>Total: CAD $37,000 - $60,000</span></li>
                    </ul>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="divide-y divide-gray-200">
                  {[
                    { q: 'What is the Post-Graduation Work Permit (PGWP)?', a: 'PGWP allows graduates to work in Canada for up to 3 years (length depends on program duration). This work experience helps qualify for permanent residency through Express Entry.' },
                    { q: 'Do I need a GIC for Canada study permit?', a: 'Yes, most students need a GIC (Guaranteed Investment Certificate) of CAD $10,000 as proof of funds. It\'s refundable after you arrive in Canada.' },
                    { q: 'Can I work while studying in Canada?', a: 'Full-time students can work up to 20 hours/week during semesters and full-time during breaks. After graduation, PGWP allows full-time work.' },
                    { q: 'Is there a pathway to permanent residency?', a: 'Yes! After gaining work experience through PGWP, you can apply for PR through Express Entry or Provincial Nominee Programs (PNP).' }
                  ].map((item, idx) => (
                ...
                <div className="bg-white rounded-2xl shadow-xl p-6">
                  ...
                  <ul className="space-y-3 text-sm text-gray-700">
                    {[
                      ...
                      'GIC CAD $10,000',
                      'Study Permit',
                      'Financial proof (CAD $37k-$60k/year)'
                    ].map((pt, i) => (
