...
import { CheckCircle, PhoneCall, ArrowRight, Target, ClipboardCheck, BookOpen, Award, Monitor, Video, Headphones } from 'lucide-react';
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <div className="flex flex-col md:flex-row items-center justify-center gap-6 text-gray-600">
                    <div className="flex items-center">
                      <PhoneCall className="mr-2 text-cyan-600" size={20} />
                      <a href="tel:+919030573605" className="hover:text-cyan-600 transition-colors">+91-9030573605</a>
                    </div>
                  </div>
                </div>
              </motion.div>
