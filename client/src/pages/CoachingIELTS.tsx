...
import { BookOpen, CheckCircle, Mail, ArrowRight, Award, Target, FileText, ClipboardCheck, Clock, DollarSign, Users, Mic, PenTool } from 'lucide-react';
...
const CoachingIELTS = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const subject = 'IELTS Coaching Inquiry';
