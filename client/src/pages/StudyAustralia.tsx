...
const StudyAustralia = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const subject = 'Study in Australia Inquiry';
  ...
  const universities = [
    { name: "Group of Eight", programs: ["Australian National University", "University of Melbourne", "University of Sydney", "UNSW Sydney"], gradient: "from-yellow-600 to-orange-600" },
    { name: "Top Business Schools", programs: ["Melbourne Business School", "AGSM (UNSW)", "UQ Business School", "Monash Business School"], gradient: "from-green-600 to-emerald-600" },
    { name: "Engineering & Technology", programs: ["UNSW Sydney", "University of Melbourne", "Monash University", "University of Queensland"], gradient: "from-blue-600 to-cyan-600" },
    { name: "Arts & Humanities", programs: ["University of Melbourne", "University of Sydney", "ANU", "University of Queensland"], gradient: "from-purple-600 to-pink-600" }
  ];
        ...
        <div className="relative z-10 container mx-auto px-4 w-full">
          <div className="max-w-6xl mx-auto">
            <nav className="text-sm text-white/80 mb-6">
              ...
              <span className="text-white">Study in Australia</span>
            </nav>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center text-white">
              <div>
                ...
                >
                  Discover world-class education in a vibrant, multicultural environment with excellent post-study work and migration opportunities.
                </motion.p>
              ...
              <div className="hidden md:block">
                <div className="glass-effect rounded-2xl p-6 shadow-neon-lg">
                  <div className="grid grid-cols-2 gap-4">
                    {[{label: 'Top Universities', value: '43'}, {label: 'International Students', value: '700K+'}, {label: 'Post-Study Work', value: '4 Years'}, {label: 'Success Rate', value: '98%'}].map((s, idx) => (
          ...
          <div className="mt-8">
            <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
              {[{icon: GraduationCap, label: 'Group of Eight'}, {icon: Award, label: 'Work Rights'}, {icon: TrendingUp, label: 'PR Pathway'}, {icon: Plane, label: 'Visa Support'}].map((it, idx) => (
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              >
                ...
                <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                  Australia is home to the prestigious Group of Eight universities and offers world-class education with a strong focus on research and innovation. The country provides excellent post-study work opportunities with the Temporary Graduate Visa (subclass 485) allowing up to 4 years of work after graduation.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Australian universities are globally recognized for their academic excellence, modern facilities, and industry connections. The country's welcoming multicultural environment, high quality of life, and clear pathways to permanent residency make it an attractive destination for international students.
                </p>
              </motion.div>

              <div className="grid md:grid-cols-2 gap-6">
                {[
                  { icon: GraduationCap, title: "Group of Eight", desc: "Prestigious research-intensive universities" },
                  { icon: Award, title: "Work While Study", desc: "Up to 40 hours/week during breaks, 20 hours during term" },
                  { icon: TrendingUp, title: "PR Pathways", desc: "Skilled migration options after graduation" },
                  { icon: Globe, title: "High Quality of Life", desc: "Beautiful cities and excellent lifestyle" }
                ].map((benefit, index) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0, y: 30 }}
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold mb-8">Our Australia Study Services</h2>
                <ul className="grid md:grid-cols-2 gap-4">
                  {[
                    ...
                    "Temporary Graduate Visa (485) support",
                    "Post-study work rights guidance",
              ...
              >
                ...
                <div className="relative border-l-2 border-yellow-100 pl-6">
                  {[
                    ...
                    { icon: Target, title: 'GTE Statement', desc: 'Genuine Temporary Entrant statement writing' },
                    { icon: ShieldCheck, title: 'Student Visa', desc: 'Subclass 500 visa application' },
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li className="flex items-start"><CheckCircle className="text-yellow-600 mr-2 mt-1" size={18} /><span>IELTS 6.0+ or PTE 50+</span></li>
                      <li className="flex items-start"><CheckCircle className="text-yellow-600 mr-2 mt-1" size={18} /><span>GTE (Genuine Temporary Entrant) statement</span></li>
                      <li className="flex items-start"><CheckCircle className="text-yellow-600 mr-2 mt-1" size={18} /><span>Statement of Purpose</span></li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start"><CheckCircle className="text-yellow-600 mr-2 mt-1" size={18} /><span>Tuition: AUD $20,000 - $45,000</span></li>
                      <li className="flex items-start"><CheckCircle className="text-yellow-600 mr-2 mt-1" size={18} /><span>Living: AUD $21,000 - $25,000</span></li>
                      <li className="flex items-start"><CheckCircle className="text-yellow-600 mr-2 mt-1" size={18} /><span>OSHC: AUD $500 - $600</span></li>
                      <li className="flex items-start"><CheckCircle className="text-yellow-600 mr-2 mt-1" size={18} /><span>Total: AUD $41,000 - $70,000</span></li>
                    </ul>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="divide-y divide-gray-200">
                  {[
                    { q: 'What is the Temporary Graduate Visa (485)?', a: 'The subclass 485 visa allows graduates to work in Australia for 18 months to 4 years depending on qualification level. This work experience can help qualify for permanent residency.' },
                    { q: 'Can I work while studying in Australia?', a: 'Yes, student visa holders can work up to 40 hours per fortnight during term and unlimited hours during breaks. This helps cover living expenses.' },
                    { q: 'What is OSHC and do I need it?', a: 'OSHC (Overseas Student Health Cover) is mandatory health insurance for international students. It covers medical and hospital costs during your stay in Australia.' },
                    { q: 'Is there a pathway to permanent residency?', a: 'Yes! After completing your studies and gaining work experience on the 485 visa, you may be eligible for skilled migration programs like 189, 190, or 491 visas.' }
                  ].map((item, idx) => (
                ...
                <div className="bg-white rounded-2xl shadow-xl p-6">
                  ...
                  <ul className="space-y-3 text-sm text-gray-700">
                    {[
                      ...
                      'Financial proof (AUD $41k-$70k/year)'
                    ].map((pt, i) => (
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-stretch">
              ...
              <div className="order-1 md:order-2">
                <img
                  src="/services/study_visa.jpg"
                  alt="Study in Australia consultation"
